...
<p>On the second stage, R code is worked with list in order to determine internal and external homonyms in comparison with other lists. The code is simple and fast, and uses R ability to vectorize calculations. In the end, two colums are added to initial list: external homonyms colum (this column has a variable name reflects names of lists which are compared), and internal homonyms ("InternalHomonymFlag"). Both columns are in binary (0/1) format.
